...
const Admin_User_Feedback = () => {
  ...
  const getFormattedFeedbackData = () => {
    return feedbacks.map((fb, index) => ({
      No: index + 1,
      Booking: fb.booking || "-",
      Guest: fb.guest?.email || "Anonymous",
      Room: fb.room?.roomNumber || "-",
      "Room Rating": fb.roomRating,
      "Service Rating": fb.serviceRating,
      "Overall Rating": fb.overallRating?.toFixed(1) || "-",
    }));
  };

  const handleExportPDF = () => {
    const data = getFormattedFeedbackData();
    ...
    doc.save("Feedback_Report.pdf"); // ✅ DOWNLOAD
  };
  ...
  const handleExportExcel = () => {
    ...
    saveAs(fileData, "Feedback_Report.xlsx"); // ✅ DOWNLOAD
  };
    ...
    <AdminLayout>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <div className="d-flex gap-2">
          ...
          <button className="red-button btn-sm small-add-button" onClick={handleExportPDF}>
            Export PDF
          </button>
        </div>
      </div>
          ...
          {feedbacks.length > 0 ? (
            feedbacks.map((fb, i) => (
              <tr key={fb._id}>
                ...
                <td>⭐ {fb.overallRating?.toFixed(1) || "-"}</td>{" "}
          ...
          <Modal.Body className="p-3">
            ...
            <Form.Group className="mb-2">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setFormData({ ...formData, roomRating: e.target.value })
                }
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setFormData({ ...formData, roomComment: e.target.value })
                }
              />
            </Form.Group>
            ...
            <Form.Group className="mb-2">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setFormData({ ...formData, serviceRating: e.target.value })
                }
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setFormData({ ...formData, serviceComment: e.target.value })
                }
              />
            </Form.Group>
      ...
      >
          ...
          {selectedFeedback ? (
            <div className="p-3">
              ...
              <div className="mb-4 p-3 rounded shadow-sm modal-section">
                ...
                <div className="row">
                  <div className="col-md-6 mb-2">
                    ...
                    <strong>
                      {selectedFeedback?.guest?.email || "Anonymous"}
                    </strong>
                  </div>
                  <div className="col-md-6 mb-2">
                    <span className="label">Room Info</span>
                    <strong>
                      #{selectedFeedback?.room?.roomNumber} (
                      {selectedFeedback?.room?.roomType})
                    </strong>
                  </div>
                </div>
              </div>
                ...
                <div className="row text-center">
                  <div className="col-md-4">
                    <div className="rating-box">
                      Room: ⭐ {selectedFeedback.roomRating}/5
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="rating-box">
                      Service: ⭐ {selectedFeedback.serviceRating}/5
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="rating-box">
                      Overall: ⭐ {selectedFeedback.overallRating?.toFixed(1)}/5
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4 p-3 rounded shadow-sm modal-section">
                ...
                <p>
                  <strong>Room:</strong> {selectedFeedback.roomComment}
                </p>
                <p>
                  <strong>Service:</strong> {selectedFeedback.serviceComment}
                </p>
              </div>
              ...
              {selectedFeedback.staffRatings?.length > 0 && (
                <div className="p-3 rounded shadow-sm modal-section">
                  ...
                  {selectedFeedback.staffRatings.map((sr, index) => (
                    <div
                      key={index}
                      className="border rounded p-3 mb-2 staff-box"
                    >
        ...
        <Modal.Footer className="d-flex justify-content-between">
          <div className="text-muted small">
            ...
            <strong>{selectedFeedback?.createdByAdmin || "N/A"}</strong>
          </div>
          <Button
