...
const Admin_Room_Booking_List = () => {
  ...
  const openEditModal = async (id) => {
    try {
      ...
      const firstRoom =
        booking_result.rooms && booking_result.rooms.length > 0
          ? booking_result.rooms[0]
          : null;
      setFormData({
        ...
        checkIn: booking_result.checkIn
          ? booking_result.checkIn.slice(0, 10)
          : "",
        checkOut: booking_result.checkOut
          ? booking_result.checkOut.slice(0, 10)
          : "",
                  ...
                  <td style={{ whiteSpace: "nowrap" }}>
                    ...
                    {booking_result.status === "confirmed" && (
                      <button
                        ...
                        onClick={() => handleCheckIn(booking_result._id)}
                      >
                        ✅ Check-In
                      </button>
                    )}
                    ...
                    {booking_result.status === "checked_in" && (
                      <button
                        ...
                        onClick={() => handleCheckOut(booking_result._id)}
                      >
                        📤 Check-Out
                      </button>
                    )}
          ...
          {selectedBooking && (
            <div id="booking-details-pdf" className="p-3">
              ...
              <h6 className="text-muted mt-4">
                Created By: {selectedBooking.createdBy?.name}
              </h6>
